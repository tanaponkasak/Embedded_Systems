...
//=================================================================================================
ModbusMaster nodeSoilMoisture;                                                                    // instantiate ModbusMaster object
//=================================================================================================
...
void setup() 
{
  ...
  while(!SerialRS485);
  //===============================================================================================
  nodeSoilMoisture.begin(5, SerialRS485);                                                         // Soil Moisture = Modbus slave ID 1
  //===============================================================================================
}
...
{
  //===============================================================================================
  result = nodeSoilMoisture.readInputRegisters(0x0001, 1);                                        // 1-InputRegister Read
  //===============================================================================================
  if(result == nodeSoilMoisture.ku8MBSuccess)
  {
    soil_moisture_float_value = nodeSoilMoisture.getResponseBuffer(0)/100.0;
    SerialDebug.print("Soil Moisture Value = ");
    SerialDebug.print(soil_moisture_float_value);                                                 // Soil Moisture
